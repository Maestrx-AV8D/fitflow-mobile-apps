...
//           <View style={styles.priceBox}>
//             <Text style={styles.priceMain}>{selected === 'ai' ? '£19.99 annually' : '£4.99 lifetime'}</Text>
//             <Text style={styles.priceSub}>Cancel anytime</Text>
//           </View>

//           <TouchableOpacity onPress={handleSubscribe} style={styles.ctaButton}>
//             <LinearGradient
//               colors={selected === 'ai' ? [colors.primary, "#4A6C6F"] : ["#000000ff", "#000000ff"]}
//               style={styles.ctaGradient}
//             >
//               <Text style={styles.ctaText}>Try 7 days free</Text>
//             </LinearGradient>
  ...
  return (
    <View style={[styles.screen, { backgroundColor: colors.background }]}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Text style={[styles.headerTitle, { color: colors.textPrimary}]}>Looking for that extra goodness?</Text>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.priceBox}>
            <Text style={styles.priceMain}>
              {selected === "ai" ? "£19.99 annually" : "£4.99 lifetime"}
            </Text>
          ...
          <TouchableOpacity onPress={handleSubscribe} style={styles.ctaButton}>
            ...
            >
              <Text style={styles.ctaText}>
                {selected === "ai" ? "Try 7 days free" : "Unlock for £4.99"}
              </Text>
            </LinearGradient>
          </TouchableOpacity>
        </View>
